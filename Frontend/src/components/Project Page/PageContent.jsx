...
{selected==1? <Calendar projectId={id} selectable={true} SbOpen={props.SbOpen}/> : selected==2?<List  projectId={id} selectable={true}/> : selected==3? <Kanban  projectId={id} selectable={true}/> : selected==4? <Messages projectId={id} /> : null}
