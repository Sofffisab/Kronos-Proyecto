...
/*
AGREGAR RUTAS, EN GET/ Y EN SETUPROUTER Y EN INDEX
  ...
  router.delete("/api/projects/:proyectoId/members/:personaId", authentication, removememberfromproject)
